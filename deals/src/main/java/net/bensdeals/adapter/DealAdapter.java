...
public class DealAdapter extends PagerAdapter {
    ...
    @Inject
    public DealAdapter(LayoutInflater inflater, Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        DealItemView dealItemView = (DealItemView) inflater.inflate(orientation.getLayout(), container, false);
